...
import SendMessageReactSvgUrl from "PUBLIC_DIR/images/send-message.svg?url";
import { InputSize, InputType } from "../../../text-input";
import { InputBlock } from "../../../input-block";
import styles from "./AIChat.module.scss";
import { classNames } from "../../../../utils";
import { AIChatPanelProps } from "../../Section.types";
...
const AIChatFooter = ({
  ...
  return (
    <div
      className={classNames(styles.AIChatFooterContainer, {
    ...
    >
      <InputBlock
        ...
        iconName={SendMessageReactSvgUrl}
        iconSize={28}
